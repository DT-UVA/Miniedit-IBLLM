from tkinter import (LabelFrame, Canvas, Scrollbar, NW, Y, VERTICAL,
                    RIGHT, LEFT, BOTH, TRUE, FALSE)

from modules.dialogs.tableframe import TableFrame
...
class VerticalScrolledTable(LabelFrame):
    ...
    * This frame only allows vertical scrolling
    ...
    def __init__(self, parent, rows=2, columns=2, title=None, **kw):
        ...
        self.interior = interior = TableFrame(
            canvas, rows=rows, columns=columns)
